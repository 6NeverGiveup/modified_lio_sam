...
public:
    ...
    void extractFeatures()
    {
        ...
        for (int i = 0; i < N_SCAN; i++)
        {
            ...
            // std::cout << "surfaceCloudScan is : " << surfaceCloudScan->size() << std::endl;
            surfaceCloudScanDS->clear();
            downSizeFilter.setInputCloud(surfaceCloudScan);
            downSizeFilter.filter(*surfaceCloudScanDS);

            // std::cout << "surfaceCloudScanDS is : " << surfaceCloudScanDS->size() << std::endl;
    ...
    {
        freeCloudInfoMemory();
        // std::cout << "cornerCloud size is : " << cornerCloud->size() << std::endl;
        // std::cout << "surfaceCloud size is : " << surfaceCloud->size() << std::endl;
        // if (surfaceCloud->size()  < 500)
        // {
        //     std::cout << "surfaceCloud size too less " << std::endl;
        //     ros::shutdown();
        // }
