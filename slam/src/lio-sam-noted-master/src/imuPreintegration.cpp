...
public:
    ...
    IMUPreintegration()
    {
        subImu = nh.subscribe<sensor_msgs::Imu>(imuTopic + "_read", 2000, &IMUPreintegration::imuHandler, this, ros::TransportHints().tcpNoDelay());
    ...
    void odometryHandler(const nav_msgs::Odometry::ConstPtr &odomMsg)
    {
        ...
        if (degenerate)
        {
            //cout << "degenerate 2 :" << degenerate << endl;
        }
    ...
    bool failureDetection(const gtsam::Vector3 &velCur, const gtsam::imuBias::ConstantBias &biasCur)
    {
        ...
        if (vel.norm() > 30)
        {
            cout << "imu_vel: " << vel.norm() * 3.6 << " km/h" << endl;
